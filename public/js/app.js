...
Vue.component('todo-list', __webpack_require__(38));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Task_vue__ = __webpack_require__(52);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		deleteTodo: function deleteTodo() {
			axios.delete('/todo/' + this.task.id);
...
var render = function() {
  ...
  return _c("div", { staticClass: "item" }, [
    ...
    _vm._v(" "),
    _c("p", { domProps: { textContent: _vm._s(_vm.task.task) } }),
    _vm._v(" "),
    _c("span", { staticClass: "flex" }, [
      _vm._v(
        _vm._s(_vm.task.hour) +
          ":" +
          _vm._s(_vm.task.minute) +
          " " +
          _vm._s(_vm.task.period)
      )
    ]),
    _vm._v(" "),
    _c(
      "button",
      { staticClass: "btn btn-sm btn-danger", on: { click: _vm.deleteTodo } },
